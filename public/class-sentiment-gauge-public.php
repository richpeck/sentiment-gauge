...
class Sentiment_Gauge_Public {
	...
	public function sentiment_gauge($atts){ 
        ...
        // https://stackoverflow.com/a/55665939/1143732 
    	ob_start();
        include( plugin_dir_path( __FILE__ ) . 'partials/sentiment-gauge-public-display.php' ); // required because otherwise it would not show inline in DIVI
        return ob_get_clean();
