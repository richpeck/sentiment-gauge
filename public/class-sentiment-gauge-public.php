...
class Sentiment_Gauge_Public {
	...
	public function sentiment_gauge($atts){ 
        ...
        // HTML
        // Build the HTML to be shown on the frontend
        $html = "<div class='gauge' style='--percent: " . $a['percent'] . ";' data-percent='" . $a['percent'] . "' onclick='var math = Math.floor(Math.random() * 100); this.setAttribute(\"style\", \"--percent: \" + math + \";\"); this.setAttribute(\"data-percent\", math);'>" . $title . "</div>";

        // Return 
        // Provide the HTML formatted response
        return $html;
