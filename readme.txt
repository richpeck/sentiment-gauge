...
Custom "sentiment gauge" plugin for Wordpress. Allows us to add sentiment gauge shortcode to pages and posts.

== Description ==

The "sentiment gauge" plugin was created to provide us with the ability to deploy a specific shortcode to the 
